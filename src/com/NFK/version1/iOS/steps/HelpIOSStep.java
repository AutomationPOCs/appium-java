...
public class HelpIOSStep {
	...
	@QAFTestStep(description="user verifies the App tour screens on home screen")
	public void userVerifiesTheAppTourScreens(){
		helpPage.verifyAppTourScreen(); 
	}
	@QAFTestStep(description="user click back button for {0}")
	public void userClickBackButton(String page) {
		helpPage.clickOnBackButton1(page);
	}
}
