...
public class DeviceSettingsSteps {
	...
	@QAFTestStep(description="user clicks device settings and clicks on notification")
	public void settingofdevice() {
		devicePage.opensetting();
	}
	
	@QAFTestStep(description="user verifies Nofifications")
	public void notifications() {
		devicePage.verifynotifications();
	}
	
	@QAFTestStep(description = "user turn off wifi")
	public void userTurnOffWifi() {
		devicePage.turnOffWifi();
	}
	@QAFTestStep(description = "user turn on wifi")
	public void userTurnOnWifi() {
