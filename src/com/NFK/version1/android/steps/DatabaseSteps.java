...
public class DatabaseSteps {
	...
	public void Query() throws SQLException{
		...
		t.executeQuery("SELECT * FROM THIRDPARTY_AUTHORIZED_APPS WHERE GLOBAL_USERS_ID IN (SELECT GLOBAL_USERS_ID FROM USERS WHERE LOGIN_ID ='BISWA.SENAPATI111@testmail.com')");
	}
	...
	public void updateQuery() throws SQLException{
		...
		t.update("UPDATE THIRDPARTY_AUTHORIZED_APPS SET REFRESH_TOKEN = '"+token+"' WHERE GLOBAL_USERS_ID IN (SELECT GLOBAL_USERS_ID FROM USERS WHERE LOGIN_ID = 'BISWA.SENAPATI111@testmail.com')");
	}
	...
	public void collectUpdateQuery() throws SQLException{
		...
		t.executeUpdateQuery("SELECT * FROM THIRDPARTY_AUTHORIZED_APPS WHERE GLOBAL_USERS_ID IN (SELECT GLOBAL_USERS_ID FROM USERS WHERE LOGIN_ID ='BISWA.SENAPATI111@testmail.com')");
	}
	...
	public void data_after_second__login() throws SQLException{
		...
		t.execute_Query_For_Second_Login("SELECT * FROM THIRDPARTY_AUTHORIZED_APPS WHERE GLOBAL_USERS_ID IN (SELECT GLOBAL_USERS_ID FROM USERS WHERE LOGIN_ID ='BISWA.SENAPATI111@testmail.com')");
	}
	...
	public void Apps_Id_DB() throws SQLException{
		...
		t.query_For_ThirdParty_AppsId("SELECT * FROM THIRDPARTY_AUTHORIZED_APPS WHERE GLOBAL_USERS_ID IN (SELECT GLOBAL_USERS_ID FROM USERS WHERE LOGIN_ID ='BISWA.SENAPATI111@testmail.com')");
	}
