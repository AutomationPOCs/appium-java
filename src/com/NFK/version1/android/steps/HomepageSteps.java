...
public class HomepageSteps {
	...
	public void verifyDeleteEventHomeScreen(String eventDetail) {
		homePageAndroid.verifyEventDeleted(eventDetail);
	}

	@QAFTestStep(description = "user verifies note event {0} is deleted on Event Log")
	public void verifyDeleteNoteEventHomeScreen(String eventDetail1) {
