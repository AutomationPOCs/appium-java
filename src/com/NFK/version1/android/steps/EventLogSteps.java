...
public class EventLogSteps {
	...
	public void addcarbsDetails(String details) {
...
//	}
	...
	public void verifyEvent(String eventDetail) {
	...
	public void userVerifyAddedNoteEventOnMyEventLog(String eventDetails1) {
	...
	@QAFTestStep(description="user deletes the Event from Event Log screen")
	public void userDeletesTheEventFromEventLogScreen(){
		eventlogPage.deleteEventSwipe();
	}
	
	@QAFTestStep(description="user delete the events using swipe")
	public void clickonevent(){
		eventlogPage.clickonaddEventsAndDelete();
	}
	
	@QAFTestStep(description = "user verifies No event on Event Log")
	public void verifyNoEventonMyEventLog() {
		eventlogPage.verifyNoGlucoseCarbActivityInsulin();
	}
	@QAFTestStep(description = "user verifies the Events")
	public void userVerifiesTheEvents() {
		eventlogPage.userVerifiesTheEvent();
	}
}