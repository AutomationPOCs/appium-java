...
public class LoginSteps {
	...
	public void userAbleToEditPrepopulatedDataFields() {
		loginPageAndroid.editResetPwdscreen();
	}
	...
	public void userNotUpdateDateofBirthFieldandRedirectToResetPassword() {
		loginPageAndroid.resetpassdob();
	}



	@QAFTestStep(description = "user gets redirected to 'Login page'")
	public void userRedirectedLoginpage() {
		loginPageAndroid.userRedirectedLoginpage();
	} 
	@QAFTestStep(description = "user enter login detail {0}")
	public void userEnterLoginDetail(String details) {
		loginPageAndroid.userEnterLoginDetail(details);
	}


	@QAFTestStep(description="user verify login button and error message")
	public void userVerifyLoginButtonAndErrorMessage() {
		loginPageAndroid.verifyLoginTabAndErrorMessage();
	}
	@QAFTestStep(description="user logins to the application with adult user details {0}")
	public void adult_user_login(String UserDetail) {
		decisionpage.selectDecisionScreen("Yes, log me in");
		decisionpage.selectDecisionOptions("My own data");
		loginPageAndroid.doLogin(UserDetail);	 
		loginPageAndroid.clicksOnLoginAndNavigateToNoticescreen();
}
	
	@QAFTestStep(description="user logins to the application with dependent user details {0}")
	public void dependent_user_login(String UserDetail) {
		decisionpage.selectDecisionScreen("Yes, log me in");
		decisionpage.selectDecisionOptions("My dependents data");
		loginPageAndroid.doLogin(UserDetail);
		loginPageAndroid.clicksOnLoginAndNavigateToNoticescreen();}
		
	
	@QAFTestStep(description ="user Verifies Notice screen")
	public void userVerifiesNoticescreen() {
		loginPageAndroid.verifyNoticeScreen();	
	}
	
	@QAFTestStep(description ="User Verifies Continue button gets Enable on clicking checkbox on notice screen")
	public void UserVerifiesContinuebuttongetsEnable() {
		loginPageAndroid.verifyContinueBtngetsEnabled();
	}
	
	@QAFTestStep(description = "user clicks on NoticeScreen continue button")
	public void userClicksOnContinueBtn() {
		loginPageAndroid.clickOnContinueBtn();
	}
	
	@QAFTestStep(description = "user verifies navigation to Welcome screen onboarding")
	public void VerifyWelcomeScreenOnboarding() {
		loginPageAndroid.verifySafetyOnBoardingPage();
	}
	...
	public void userEnterRequiredDetailsAndClickOnSendButton() {
		loginPageAndroid.fillSignUpDetails();
	}
	...
	public void clickOnLogin_Btn_VerifyNoticeScreen() {
		loginPageAndroid.ClickOnLogin_BtnAndVerifyNotice();
	}
	...
	public void clickOnLogin_Btn_VerifyErrorMessage() {
		loginPageAndroid.ClickOnLogin_BtnAndVerifyErrorMessage();
	}
	...
	public void clearFieldEnterPassword(String password) {
		loginPageAndroid.clearField_EnterPassword(password);
	}
}
