...
public class EventLogPageAndroid extends WebDriverBaseTestPage<WebDriverTestPage> {
	...
	@FindBy(locator = "NFK.eventlog.event.event1")
	private QAFWebElement NFKEventLogevent1;
	@FindBy(locator = "NFK.eventlog.event.home.btn")
	private QAFWebElement NFKEventLogeventhomebtn;

	@FindBy(locator = "NFK.eventlog.event.event.delete.btn")
	private QAFWebElement NFKEventLogeventdeletebtn;
	@FindBy(locator = "NFK.eventlog.event.event.deletepopup.title")
	private QAFWebElement NFKEventLogeventdeletepopuptitle;
	@FindBy(locator = "NFK.eventlog.event.event.deletepopup.option")
	private QAFWebElement NFKEventLogeventdeletepopupdeleteoption;
	@FindBy(locator ="NFK.eventlog.event.activity.option")
	private QAFWebElement NFKEventlogEventActivityOption;
	@FindBy(locator ="NFK.eventlog.event.carbs.option")
	private QAFWebElement NFKEventlogEventCarbsOption;
	@FindBy(locator ="NFK.eventlog.event.insulin.option")
	private QAFWebElement NFKEventlogEventInsulinOption;
	
	
	public static int firstCarb, secCarb;

	public QAFWebElement getNFKEventLogevent1() {
		return NFKEventLogevent1;
	}

	public QAFWebElement getNFKEventLogeventdeletepopuptitle() {
		return NFKEventLogeventdeletepopuptitle;
	}

	public QAFWebElement getNFKEventLogeventdeletepopupdeleteoption() {
		return NFKEventLogeventdeletepopupdeleteoption;
	}

	public QAFWebElement getNFKEventLogeventdelete() {
		return NFKEventLogeventdeletebtn;
	}

	public QAFWebElement getNFKEventLogeventhomebtn() {
		return NFKEventLogeventhomebtn;
	}
	...
	public QAFWebElement getNFKEventlogEventActivityOption() {
		return NFKEventlogEventActivityOption;
	}
	...
	public QAFWebElement getNFKEventlogEventCarbsOption() {
		return NFKEventlogEventCarbsOption;
	}
	public QAFWebElement getNFKEventlogEventInsulinOption() {
		return NFKEventlogEventInsulinOption;
	}
	...
	public void selectFutureDate() {
		...
		if (LFSUtilsAndroid.getCurrentDate().equalsIgnoreCase("30")
			...
			LFSUtilsAndroid.click(getNFKEventLogClassicViewDateToRightBtn());
			date = 1;
		}
		ConfigurationManager.getBundle().setProperty("selected.date", date);
	...
	public void addCarbManualDetail(String eventDetail) {
		EventDetailBeans eventBean = new EventDetailBeans();
		if (eventDetail instanceof String) {
			eventBean.fillFromConfig(eventDetail);
		} else {
			eventBean.fillData(eventDetail);
		}
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), eventBean.getAmount());
		LFSUtilsAndroid.enterText(getNFKEventLogEditglucoseNoteFieldTxt(), "Adding carb details");
		LFSUtilsAndroid.click(getNFKEventLogaddbgtimebtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		Reporter.logWithScreenShot("Carbs window after adding details", MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogaddeventsavebtn());
		Reporter.logWithScreenShot("User added carb details", MessageTypes.Pass);
	}

	// method to edit carb details
	public void editCarbsDetail(String eventDetail) {
		getNFKEventLogEditglucoseEditeventtitleTxt().waitForPresent();
		EventDetailBeans eventBean = new EventDetailBeans();
		if (eventDetail instanceof String) {
			eventBean.fillFromConfig(eventDetail);
		...
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), eventBean.getAmount());
		LFSUtilsAndroid.enterText(getNFKEventLogEditglucoseNoteFieldTxt(), "Editing carb details");
		LFSUtilsAndroid.click(getNFKEventLogaddbgtimebtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		Reporter.logWithScreenShot("Carbs window after editing value", MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogaddeventsavebtn());
		Reporter.logWithScreenShot("User edited carb event", MessageTypes.Pass);
	}

	public static String insulinValue;

	// method to add insulin details
	public void addInsulinDetail(String eventDetail) {
		EventDetailBeans eventBean = new EventDetailBeans();
		if (eventDetail instanceof String) {
			eventBean.fillFromConfig(eventDetail);
		} else {
		...
		Reporter.logWithScreenShot("Insulin window after adding value", MessageTypes.Pass);
		LFSUtilsAndroid.enterText(getNFKEventLogEditglucoseNoteFieldTxt(), "Entering Insulin detail");
		LFSUtilsAndroid.click(getNFKEventLogaddbgtimebtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventsavebtn());
		Reporter.logWithScreenShot("User added insulin details", MessageTypes.Pass);
	}

	// Method to edit insulin details
	public void editInsulinDetail(String eventDetail) {
		getNFKEventLogEditglucoseEditeventtitleTxt().waitForPresent();
		EventDetailBeans eventBean = new EventDetailBeans();
		if (eventDetail instanceof String) {
			eventBean.fillFromConfig(eventDetail);
		...
		Reporter.logWithScreenShot("Insulin window before editing", MessageTypes.Pass);
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), eventBean.getAmount());
		LFSUtilsAndroid.click(getNFKEventLogaddbgtimebtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		Reporter.logWithScreenShot("Insulin window after editing", MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogaddeventsavebtn());
		Reporter.logWithScreenShot("User edited insulin details", MessageTypes.Pass);
	}

	// Method to enter activity details
	public void addActivityDetail(String eventDetail) {
		getNFKEventLogEditglucoseEditeventtitleTxt().waitForPresent();
		EventDetailBeans eventBean = new EventDetailBeans();
		if (eventDetail instanceof String) {
			eventBean.fillFromConfig(eventDetail);
		...
		Reporter.logWithScreenShot("Activity window before entering value", MessageTypes.Pass);
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), eventBean.getAmount());
		LFSUtilsAndroid.click(getNFKEventLogaddactivityselectintensitybtn());
		selectIntensity();
		LFSUtilsAndroid.enterText(getNFKEventLogEditglucoseNoteFieldTxt(), "Entering Activity detail");
		LFSUtilsAndroid.click(getNFKEventLogaddbgtimebtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		Reporter.logWithScreenShot("Activity window after entering value", MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogaddeventsavebtn());
		Reporter.logWithScreenShot("User added Activity details", MessageTypes.Pass);
	}

	public void addNoteText(String noteText) {
		LFSUtilsAndroid.enterText(getNFKEventLogaddeventnoteField(), noteText);
	}

	public void addNoteDetails(String eventDetails) {
		EventDetailBeans eventBean = new EventDetailBeans();
		if (eventDetails instanceof String) {
			eventBean.fillFromConfig(eventDetails);
		} else {
		...
		LFSUtilsAndroid.hideKeyboard();
		Reporter.logWithScreenShot("Note window after adding value is " + eventBean.getnote(), MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogaddeventsavebtn());
		Reporter.logWithScreenShot("User added note  as " + eventBean.getnote(), MessageTypes.Pass);
	}

	public void verifyAddedNoteEventOnEventLogScreen(String eventDetails1) {
		try {
			EventDetailBeans eventBean1 = new EventDetailBeans();
			LFSUtilsAndroid.click(getNFKhomepageEventLogtab());
			Reporter.logWithScreenShot("Added event on Event log screen", MessageTypes.Pass);
			if (eventDetails1 instanceof String) {
				eventBean1.fillFromConfig(eventDetails1);
			} else {
			...
			WebDriverTestCase.verifyTrue(getsubstr.equals(substr), " Incorrect value is displayed ",
					"Entered Note is " + eventBean1.getnote());
			Reporter.logWithScreenShot("User verified added note event on Event Log Screen", MessageTypes.Pass);
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to verify added note event on Event Log Screen", MessageTypes.Fail);
		}
	...
	public void clickOnAddedNoteEvent() {
		LFSUtilsAndroid.click(getNFKEventLogeventlogaddednote());
		getNFKEventLogaddeventnoteField().waitForPresent(1000);
		Reporter.logWithScreenShot("User clicked on added note event", MessageTypes.Pass);
	}

	// method for edit note details
	public void editNoteDetails(String eventDetail) {
		EventDetailBeans eventBean1 = new EventDetailBeans();
		if (eventDetail instanceof String) {
			eventBean1.fillFromConfig(eventDetail);
		} else {
		...
		Reporter.logWithScreenShot("User edited note details", MessageTypes.Pass);
	}
	...
	public void confirmDeleteSelectedEvent() {
		...
		Reporter.logWithScreenShot("User clicked on Delete button of confirm delete popup", MessageTypes.Pass);
	}

	// Method to verify delete pop up and delete event
	public void verifyDeleteEvent() {
		androidDriver.hideKeyboard();
		LFSUtilsAndroid.click(getNFKEventLogEditglucoseDeleteBtn());
		getNFKEventLogaddeventtimeselectcancelbtn().verifyPresent("Cancel button");
		getNFKEventLogEditglucoseDeleteconfirmTxt().verifyPresent("Confirm delete text");
		getNFKEventLogEditglucoseDeletepopupDeleteBtn().verifyPresent("Delete button on popup");
		Reporter.logWithScreenShot("User verified delete event popup", MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectcancelbtn());
	...
	public void deleteEvent() {
		LFSUtilsAndroid.click(getNFKEventLogEditglucoseDeleteBtn());
		Reporter.logWithScreenShot("User clicked on delete event button", MessageTypes.Pass);
		getNFKEventLogEditglucoseDeletepopupDeleteBtn().click();
		Reporter.logWithScreenShot("User clicked on Delete button of confirm delete popup", MessageTypes.Pass);
	}
	...
	public void verifyScreens(String screenname) {
		...
		Reporter.logWithScreenShot("Verified the Add an Event screen: " + screenname, MessageTypes.Pass);
	...
	public void verifyTimePopUp() {
		...
		WebDriverTestCase.verifyTrue(
				getNFKEventLogpageStaticText("AM").getAttribute("checked").equalsIgnoreCase("true"),
	...
	public void verifyAddCarbEventScreen() {
		try {
			getNFKEventLogaddbgaddvaluetxt().verifyPresent("Carb value text field");
			getNFKEventLogunitofmeasurementlbl().verifyPresent("UOM for carb");
			getNFKEventLogaddbgtimebtn().verifyPresent("Time value");
			getNFKEventLogEditglucoseNoteFieldTxt().verifyPresent("Note text field");
			getNFKEventLogaddeventsavebtn().verifyPresent("Save button");
			getNFKEventLogEditglucoseBackBtn().verifyPresent("Back button");
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to verify Carb Event Screen", MessageTypes.Fail);
		}
	}

	// Method to verify add event screen for insulin
	public void verifyAddInsulinEventScreen() {
		getNFKEventLogaddbgaddvaluetxt().verifyPresent("Insulin text field");
		...
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), "9.11");
		Reporter.logWithScreenShot("Entering the valueeeeee 9.11111", MessageTypes.Pass);

		WebDriverTestCase.verifyTrue(getNFKEventLogaddbgaddvaluetxt().getText().equals("---"),
				"Insulin field accepting more than one decimal place ",
				"Insulin field not accepting two decimal place");
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), "9.1");
		LFSUtilsAndroid.hideKeyboard();

		System.out.println("get thee valueee +++" + getNFKEventLogaddbgaddvaluetxt().getText());
		WebDriverTestCase.verifyTrue(getNFKEventLogaddbgaddvaluetxt().getText().equals("9.1"),
				"Insulin field accepting more than one decimal place",
				"Insulin field accepting upto one decimal place");
		LFSUtilsAndroid.click(getNFKEventLogaddinsulinselecttypebtn());
		verifyInsulinTypePopUp();
		selectinsulin();
		String str1 = getNFKEventLogTypeTxt().getText();
		WebDriverTestCase.assertTrue(str1.contains(LFSUtilsAndroid.getPropString("event.detail.insulinController.nph")),
	...
	private void selectinsulin() {
		...
		for (int i = 0; i < 5; i++) {
			...
			if (gettype.equals(type)) {
				LFSUtilsAndroid.click(getNFKEventLogTypePickerDone());
				Reporter.logWithScreenShot("User selected the correct type of Insulin ", MessageTypes.Pass);
				break;
			} else {
				LFSUtilsAndroid.click(getNFKEventLogTypePickerBtn());
			}
		}
	}
	...
	public void verifyInsulinTypePopUp() {
		...
		list.add("Short-acting");
		list.add("Long-acting");
		list.add("Mix");
		list.add("NPH");
//		list.add("Rapid");
		for (String item : list) {
			...
			if (item.equals(strtype)) {
				Reporter.logWithScreenShot("User verified insulin type: " + strtype, MessageTypes.Pass);
			} else {
				Reporter.logWithScreenShot("Insulin type is incorrect ", MessageTypes.Fail);
			}
			LFSUtilsAndroid.click(getNFKEventLogTypePickerBtn());
		}
	}
	...
	public void verifyAddActivityEventScreen() {
		...
		getNFKEventLogaddbgaddvaluetxt().verifyPresent("Activity value text field");
		...
		getNFKEventLogaddeventsavebtn().verifyPresent("Save button");
		getNFKEventLogEditglucoseBackBtn().verifyPresent("Back button");
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), randomNumberActivity + "");
		LFSUtilsAndroid.click(getNFKEventLogaddactivityselectintensitybtn());
	...
	public void verifyAddNoteEvenetScreen() {
		try {
			...
			Reporter.logWithScreenShot("Fail to verify note event screen", MessageTypes.Fail);
		}
	}
	...
	public void verifyIntensityTypePopUp() {
		...
		for (String typeactivity : listactivity) {
			...
			if (typeactivity.equals(strntype)) {
				Reporter.logWithScreenShot("User verified Activity intensity " + strntype, MessageTypes.Pass);
			} else {
				Reporter.logWithScreenShot("Activity type is incorrect: " + strntype, MessageTypes.Fail);
			}
			LFSUtilsAndroid.click(getNFKEventLogTypePickerBtn());
		}
	}
	...
	public void VerifyHILOvalue(String value) {
		...
		for (int i = 1; i <= getNFKEventLogaddbgaddvaluetxtList().size(); i++) {
			if (value.equalsIgnoreCase("LO")) {
				WebDriverTestCase.verifyTrue(getNFKEventLogaddbgaddvaluetxt().getAttribute("value").contains("LO"),
		...
		for (int i = 1; i <= getNFKEventLogaddbgaddvaluetxtList().size(); i++) {
			if (value.equalsIgnoreCase("HI")) {
				WebDriverTestCase.verifyTrue(getNFKEventLogaddbgaddvaluetxt().getAttribute("value").contains("HI"),
	...
	public void verifysavedEvent() {
		getNFKhomepageEventLogtab().click();
		Reporter.logWithScreenShot("User redirected to Event log screen", MessageTypes.Pass);
	}
	...
	public void allowedNoteRangeTime() {
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), "200");
		LFSUtilsAndroid.click(getNFKEventLogaddbgtimebtn());
		verifyTimePickerFutureNotAllowed();
		maxAllowedNoteFieldCharacter();
		Reporter.logWithScreenShot("User verified note feild and future timing", MessageTypes.Pass);
	}
	...
	public void maxAllowedNoteFieldCharacter() {
		try {
			...
			LFSUtilsAndroid.enterText(getNFKEventLogEditglucoseNoteFieldTxt(), typeName);
			Validator.verifyThat("Note charcter length", getNFKEventLogEditglucoseNoteFieldTxt().getText().length(),
	...
	public void verifyTimePickerFutureNotAllowed() {
		try {
			...
			int date = Integer.parseInt(LFSUtilsAndroid.getCurrentDate()) + 1;
			ConfigurationManager.getBundle().setProperty("selected.date", date);
			if (ConfigurationManager.getBundle().getProperty("selected.date")
					.equals(LFSUtilsAndroid.getCurrentDate())) {
				LFSUtilsAndroid.waitforLoad();
	...
	public void insulinAllowedRangeTimeType() {
		...
		getNFKEventLogaddinsulinselecttypebtn().click();
		getNFKEventLogpageStaticText(ConfigurationManager.getBundle().getString("insulin.insulinType"))
				.waitForPresent();
		getNFKEventLogpageStaticText(ConfigurationManager.getBundle().getString("event.detail.insulinController.short"))
				.click();
...
//			Reporter.logWithScreenShot("Insulin window after adding value" + randomNumberInsulin, MessageTypes.Pass);
			...
			for (int i = 0; i < arrData.length; i = i + 2) {
				for (int j = 0; j < getNFKEventLogaddbgaddvaluetxtList().size();) {
					if (getNFKEventLogaddbgaddvaluetxtList().get(j).getText().equals(arrData[i])) {
						Reporter.logWithScreenShot(arrData[i] + arrData[i + 1] + " Event is Present",
								MessageTypes.Pass);
					}
					j++;
				}
			}
			Reporter.logWithScreenShot("User verified added event on Event screen", MessageTypes.Pass);
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to verify added event on Event screen", MessageTypes.Fail);
		}
				...
				if (getNFKEventLogaddbgaddvaluetxtList().get(i).getText().contains(randomNumberGlucose)) {
					...
					for (int j = 0; j < getNFKEventLogaddbgaddvaluetxtList().size(); j++) {
						...
						if (getNFKEventLogaddbgaddvaluetxtList().get(j).getText().contains(randomNumberGlucose)) {
							...
							getNFKEventLogaddbgaddvaluetxtList().get(j)
									.sendKeys(Integer.toString(randomNumberGlucose0));
							LFSUtilsAndroid.hideKeyboard();
	...
	public void verifyRandomGlucose() {
		...
		String randomNumberBG = ConfigurationManager.getBundle().getProperty("classic.glucose").toString();

		if (getNFKEventLogaddbgaddvaluetxt().getText().equals(randomNumberBG)) {
			WebDriverTestCase.verifyTrue(getNFKEventLogaddbgaddvaluetxt().getText().equals(randomNumberBG),
	...
	public void editRandomCarb() {
		String randomNumberCarb = ConfigurationManager.getBundle().getProperty("classic.carb").toString();
		int randomNumberCarb1 = ThreadLocalRandom.current().nextInt(21, 200);
		editEventValue(randomNumberCarb, randomNumberCarb1);
		ConfigurationManager.getBundle().setProperty("classic.carb", randomNumberCarb1);
		Reporter.logWithScreenShot("Carb window after editing value" + randomNumberCarb1, MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogAddeventUnitLbl());

	}

	public void editEventValue(String oldeventValue, int newEventValue) {
		for (int i = 0; i < getNFKEventLogaddbgaddvaluetxtList().size(); i++) {
			if (getNFKEventLogaddbgaddvaluetxtList().get(i).getText().equals(oldeventValue)) {
				LFSUtilsAndroid.click(getNFKEventLogAddeventUnitLblList().get(i));
				LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), newEventValue + "");
				LFSUtilsAndroid.hideKeyboard();
				break;
			}
		}
	...
	public void editRandomInsulin() {
		String randomNumberInsulin = ConfigurationManager.getBundle().getProperty("classic.insulin").toString();
		int randomNumberInsulin1 = ThreadLocalRandom.current().nextInt(21, 200);
		editEventValue(randomNumberInsulin, randomNumberInsulin1);
		ConfigurationManager.getBundle().setProperty("classic.insulin", randomNumberInsulin1);
	...
	public void editRandomActivity() {
		String randomNumberActivity = ConfigurationManager.getBundle().getProperty("classic.activity").toString();
		int randomNumberActivity1 = ThreadLocalRandom.current().nextInt(21, 200);
		editEventValue(randomNumberActivity, randomNumberActivity1);
		ConfigurationManager.getBundle().setProperty("classic.activity", randomNumberActivity1);
		Reporter.logWithScreenShot("Activity window after editing value" + randomNumberActivity1, MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogAddeventUnitLbl());
	}
...
//		getNFKEventLogaddbgaddvaluetxt().click();
	...
	public void selecttypeofInsulin(String insulintype) {
		...
		LFSUtilsAndroid.click(getNFKEventLogaddeventsavebtn());
		Reporter.logWithScreenShot("User selected insulin type: " + insulintype, MessageTypes.Pass);
	}

	public void verifytypeofInsulin(String typeinsulin) {
		getNFKEventLogaddinsulinselecttypebtn().verifyPresent("Insulin type value");
		int randomInsulin = ThreadLocalRandom.current().nextInt(10, 200);
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), randomInsulin + "");
		String selectedInsulin = ConfigurationManager.getBundle().getProperty("classic.insulin").toString();
		if (typeinsulin.equals(selectedInsulin)) {
			Validator.verifyThat(typeinsulin, Matchers.equalTo(selectedInsulin));
	...
	public void editActivityDetail(String eventDetail) {
		getNFKEventLogEditglucoseEditeventtitleTxt().waitForPresent();
		EventDetailBeans eventBean = new EventDetailBeans();
		if (eventDetail instanceof String) {
			eventBean.fillFromConfig(eventDetail);
		...
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		LFSUtilsAndroid.click(getNFKEventLogaddeventtimeselectokbtn());
		Reporter.logWithScreenShot("Activity window after Editing value", MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKEventLogaddeventsavebtn());
		Reporter.logWithScreenShot("User edited activity details", MessageTypes.Pass);
	...
	public void selecttypeofActivity(String activitytype) {
		...
		for (int i = 0; i < 4; i++) {
			...
			if (gettypetext.equals(activitytype)) {
				Reporter.logWithScreenShot("User selected Activity type: " + activitytype, MessageTypes.Pass);
	...
	public void verifytypeofActivity(String typeActivity) {
		...
		LFSUtilsAndroid.enterText(getNFKEventLogaddbgaddvaluetxt(), randomActivity + "");
		String selectedActivity = ConfigurationManager.getBundle().getProperty("classic.activity").toString();
		if (typeActivity.equals(selectedActivity)) {
			Validator.verifyThat(typeActivity, Matchers.equalTo(selectedActivity));
	...
	public void addMultiEvents(String option, int a) {
		try {
			...
			LFSUtilsAndroid.click(homeAndroid.getNFKHomepageAddeventTxt());
			option = option.toUpperCase();
			switch (option) {

			case "GLUCOSE":
				LFSUtilsAndroid.click(getNFKEventLogaddeventaddbgvaluebtn());
				addBG(a);
				break;

			case "CARBS":
				LFSUtilsAndroid.click(getNFKEventLogaddeventaddcarbvaluebtn());
				addCarb(a);
				break;

			case "INSULIN":
				LFSUtilsAndroid.click(getNFKEventLogaddeventaddinsulinvaluebtn());
				addInsulin(a);
				break;

			case "ACTIVITY":
				LFSUtilsAndroid.click(getNFKEventLogaddeventaddactivityvaluebtn());
				addActivity(a);
				break;
			}
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to add multiple events", MessageTypes.Fail);
		}
	...
	public void addActivity(int a) {
		...
		ConfigurationManager.getBundle().setProperty("classic.activity", randomNumberActivity);
		addEventValue(a, randomNumberActivity);
		Reporter.logWithScreenShot("User added Activity value" + randomNumberActivity, MessageTypes.Pass);
	}

	public void addInsulin(int a) {
		int randomNumberInsulin = ThreadLocalRandom.current().nextInt(10, 200);
		ConfigurationManager.getBundle().setProperty("classic.insulin", randomNumberInsulin);
		addEventValue(a, randomNumberInsulin);
		Reporter.logWithScreenShot("User added Insulin value" + randomNumberInsulin, MessageTypes.Pass);
	}

	public void addCarb(int a) {
		int randomNumberCarb = ThreadLocalRandom.current().nextInt(1, 200);
		ConfigurationManager.getBundle().setProperty("classic.carb", randomNumberCarb);
		addEventValue(a, randomNumberCarb);
		Reporter.logWithScreenShot("User added Carb value" + randomNumberCarb, MessageTypes.Pass);
	}

	public void addEventValue(int a, int value) {
		getNFKEventLogaddbgaddvaluetxt().sendKeys(value + "");
		LFSUtilsAndroid.hideKeyboard();
		LFSUtilsAndroid.click(getNFKEventLogAddeventUnitLblList().get(a));
		LFSUtilsAndroid.hideKeyboard();
	}
	...
	public void addBG(int a) {
		if (getNFKEventLogunitofmeasurementlbl().getText().equalsIgnoreCase("mmol/l")) {
			...
			ConfigurationManager.getBundle().setProperty("classic.glucose", randomNumberGlucose);
			enterManualBGvalue(randomNumberGlucose);
			Reporter.logWithScreenShot("After adding Glucose value" + randomNumberGlucose, MessageTypes.Pass);
		}
	}
	...
	public void editMultiEvent(String option) {
		...
		LFSUtilsAndroid.click(getNFKEventLogaddeventlbl());
		Reporter.logWithScreenShot("User edited Event: " + option, MessageTypes.Pass);
	...
	public void verifyEventLog() {
		try {
			...
			Reporter.logWithScreenShot("User verified the Event Log Screen", MessageTypes.Pass);
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to verify Event Log Screen", MessageTypes.Fail);
		}
	}
	...
	public void scrollChart() {
		try {
			...
			int c = 1;
			LFSUtilsAndroid.click(getNFKEventlogEventToggleCalendarBtn());
			do {
				LFSUtilsAndroid.swipeWithCoordinates(p.getX() + 200, p.getY(), p.getX() + 1300, p.getY(), 10);
				c++;
			} while (c <= 3);
			...
			Reporter.logWithScreenShot("Fail to scroll upto 90 days ", MessageTypes.Fail);
		}
	}
	...
	public void verifyEditedAdded() {
		...
		for (int i = 0; i < home.getNFKHomepageEventValueTxt().size(); i++) {
			...
			Reporter.logWithScreenShot("Events present " + home.getNFKHomepageEventValueTxt().get(i).getText(),
					MessageTypes.Pass);

		}
	}

	public void deleteEventSwipe() {

		HomePageAndroid home = new HomePageAndroid();
//		 getNFKhomepageEventLogtab().click();
		// getNFKhomepageEventLogtab().waitForPresent(200);
		getNFKEventLogpageStaticText(ConfigurationManager.getBundle().getString("appCommon.ok")).click();
		Point p = home.getNFKHomepageEventValueTxt().get(1).getLocation();

		LFSUtilsAndroid.swipeWithCoordinates(p.getX() + 200, p.getY(), p.getX() + 1300, p.getY(), 10);
		LFSUtilsAndroid.pause(2000);
		Reporter.logWithScreenShot("Scrolled to left ", MessageTypes.Pass);
	}

	// Roshani
	public void deleteviaswipe() {
		getNFKEventLogeventdelete().waitForPresent();
		getNFKEventLogeventdelete().isPresent();
		getNFKEventLogeventdelete().click();
		getNFKEventLogeventdeletepopuptitle().waitForPresent();
		;
		getNFKEventLogeventdeletepopupdeleteoption().isPresent();
		getNFKEventLogeventdeletepopupdeleteoption().click();
	}

	// Roshani
	public void clickonaddEventsAndDelete() {
		try {
			for (int i = 1; i <= 3; i++) {
				getNFKEventLogevent1().isPresent();
				getNFKEventLogevent1().isSelected();
				LFSUtilsAndroid.swipeWithScreenPercent(80, 50, 8, 50, 1);
				deleteviaswipe();
			}
			getNFKEventLogeventhomebtn().click();
			LFSUtilsAndroid.waitforLoad();
...
//		//String randomBG = ConfigurationManager.getBundle().getProperty("classic.glucose").toString();
		...
		for (int i = 0; i < arrData.length; i = i + 2) {
			...
			for (int j = 0; j < getNFKEventLogaddbgaddvaluetxtList().size();) {
				if (!(getNFKEventLogaddbgaddvaluetxtList().get(j).getText().equals(arrData[i]))) {
					Reporter.logWithScreenShot(arrData[i] + arrData[i + 1] + " Event is not Present",
							MessageTypes.Pass);
				}
				j++;
		...
		Reporter.logWithScreenShot("Added event not present on Event screen Removed sucessfully", MessageTypes.Pass);
	...
	public void userVerifiesTheEvent() {
		getNFKEventlogEventActivityOption().verifyPresent();
		getNFKEventlogEventCarbsOption().verifyPresent();
		getNFKEventlogEventInsulinOption().verifyPresent();
	}
