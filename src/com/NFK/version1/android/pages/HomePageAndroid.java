...
public class HomePageAndroid extends WebDriverBaseTestPage<WebDriverTestPage> {
	...
	@FindBy(locator = "NFK.homepage.startTour.btn")
	private QAFWebElement NFKHomepageStartTourBtn;
	...
	public QAFWebElement getNFKHomepageStartTourBtn() {
		return NFKHomepageStartTourBtn;
	}
	...
	public void clickMoreMenu() {
		LFSUtilsAndroid.click(getNFKHomepageMoreBtn());
	...
	public void clickOnaddEvent(String value) {
		...
		for (QAFWebElement ele : getNFKHomepageEventValueTxt()) {
			if ((LFSUtilsAndroid.tryDisplayMethod(ele)) || (ele.getText().contains(value))) {
				LFSUtilsAndroid.click(ele);
				Reporter.logWithScreenShot("User clicked on added event", MessageTypes.Pass);
				count++;
				break;
			}
		}
	...
	public void verifyAddedEventtimelineScreen(String eventDetail) {
		try {
			EventDetailBeans eventBean = new EventDetailBeans();
			if (eventDetail instanceof String) {
			...
			Reporter.logWithScreenShot("Fail to verify added event", MessageTypes.Fail);
		}
	}

	// Method to verify event is deleted
	public void verifyEventDeleted(String eventDetail) {
		try {
			EventDetailBeans eventBean = new EventDetailBeans();
			if (eventDetail instanceof String) {
				eventBean.fillFromConfig(eventDetail);
			...
			for (int i = 0; i < getNFKHomepageEventValueTxt().size(); i++) {
				if (LFSUtilsAndroid.tryDisplayMethod(getNFKHomepageEventValueTxt().get(i))
					...
					LFSUtilsAndroid.click(getNFKHomepageEventValueTxt().get(i));
			...
			Reporter.logWithScreenShot("Fail to delete event", MessageTypes.Fail);
		}

	}

	public void verifyNoteEventDeleted(String eventDetail) {
		EventDetailBeans eventBean = new EventDetailBeans();
		if (eventDetail instanceof String) {
			eventBean.fillFromConfig(eventDetail);
		} else {
	...
	public void homepageAddEvent() {
		LFSUtilsAndroid.click(getNFKHomepageAddeventTxt());
	...
	public void selectActivity() {
		LFSUtilsAndroid.click(getNFKHomepageAddeventACTIVITYBtn());
	}

	public void selectInsulin() {
		LFSUtilsAndroid.click(getNFKHomepageAddeventInsulinBtn());
	}

	public void selectCarb() {
		LFSUtilsAndroid.click(getNFKHomepageAddeventCARBBtn());
	}

	public void selectBG() {
		LFSUtilsAndroid.click(getNFKHomepageAddeventBGBtn());

	}

	public void selectNote() {
		LFSUtilsAndroid.click(getNFKhomepageaddeventnotebtn());
	}

	public void clickBG() {
		LFSUtilsAndroid.click(getNFKHomepageAddeventBGBtn1());
	...
	public void verifyEvents() {
		EventLogPageAndroid logbook = new EventLogPageAndroid();
		logbook.getNFKEventLogaddeventaddactivityvaluebtn().verifyNotVisible("Ativity event");
		logbook.getNFKEventLogaddeventaddcarbvaluebtn().verifyNotVisible("Carbs event");
	...
	public void verifyEmptyHomeScreen() {
		assertEquals(getNFKHomepageBannerMsgLbl().getText(),
				LFSUtilsAndroid.getPropString("home.no.alert.alarm.banner"));
		...
		assertEquals(getNFKHomepageSensorHowtoapplyBtn().getText(),
				LFSUtilsAndroid.getPropString("home.how.apply.sensor"));
...
//	Method to click on home tab
	public void clickOnHomeTab() {
		try {
			LFSUtilsAndroid.click(getNFKHomepageHomeBtn());
	...
	public void verifyhomescreen() {
		try {
			getNFKHomepageLastreadingTrendsDateStatictextBtn(LFSUtilsIOS.getPropString("home.noAlert.banner"))
					.verifyPresent("No Alerts");
			getNFKHomepageLastreadingTrendsDateStatictextBtn(LFSUtilsIOS.getPropString("home.sensor.text"))
					.verifyPresent("While your sensor is warming up");
			getNFKHomepageStartTourBtn().assertPresent("satrt tour");
