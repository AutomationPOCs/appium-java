...
public class HelpPageAndroid extends WebDriverBaseTestPage<WebDriverTestPage> {
	...
	@FindBy(locator = "NFK.moremenu.helppage.title.lbltext")
	private List<QAFWebElement> NFKMoremenuHelppageTitleLbltext;

	@Override
	protected void openPage(PageLocator pageLocator, Object... args) {
	}

	public List<QAFWebElement> getNFKMoremenuHelppageTitleLbltext() {
		return NFKMoremenuHelppageTitleLbltext;
	}
	...
	public void verifyHelpIntroductionPage() {
		...
		getNFKMoremenuHelppageStatictextTxt(ConstantUtils.HELP_INTRO_OTR_MOBILE_APP)
				.verifyPresent("OneTouch Reveal® mobile app");
		...
		getNFKMoremenuHelppageStatictextTxt(ConstantUtils.HELP_INTRO_ANDROID).verifyPresent("Android");
		getNFKMoremenuHelppageStatictextTxt(ConstantUtils.HELP_INTRO_GOOGLE_PAY).verifyPresent("Google Play");
		getNFKMoremenuHelppageStatictextTxt(ConstantUtils.HELP_INTRO_BLUETOOTH).verifyPresent("Bluetooth® Trademark"); // Bluetooth®
																														// Trademark
	...
	public void verifiesAboutHelpPage() {
		...
		getNFKMoremenuHelppageStatictextTxt(ConstantUtils.HELP_APP_ABOUT_UDI).assertPresent("UDI of Mobile");
	...
	public void verifiesSettingHighLowHelp() {
		...
		getNFKMoremenuHelppageStatictextTxt(ConstantUtils.HELP_APP_ABOUTME_SETTING_LIMITS)
				.verifyPresent("Setting your High and Low limits");
		LFSUtilsAndroid.clickBackButton();
	}
...
//	}
	...
	public void clicksInsulinMentor() {
		QAFWebElement insulinMentor = getNFKMoremenuHelppageStatictextTxt(
				(String) LFSUtilsAndroid.getPropString("insulinCalc.firstUse.welcome.title").subSequence(0, 7));
		...
		if (insulinMentor.isPresent()) {
			...
			getNFKMoremenuHelppageStatictextTxt(
					ConfigurationManager.getBundle().getString("insulinCalc.firstUse.welcome.title")).click();
		} else {
			Reporter.logWithScreenShot("Insulin Mentor is not present", MessageTypes.Fail);

		}
	}

	public void clicksQuickUse() {
		QAFWebElement QuickUse = getNFKMoremenuHelppageStatictextTxt(
				(String) LFSUtilsAndroid.getPropString("summary.screenTitle").subSequence(0, 7));
		QuickUse.waitForPresent();
		if (QuickUse.isPresent()) {
			Reporter.logWithScreenShot("Quick Use Tutorial is present", MessageTypes.Pass);
			getNFKMoremenuHelppageStatictextTxt(ConfigurationManager.getBundle().getString("summary.screenTitle"))
					.click();
		} else {
	...
	public void clickYourInsulin_Mentor() {
		if (getNFKMoremenuHelppageInsulinmentorTxt().isDisplayed()) {
			Reporter.logWithScreenShot("Your Insulin Mentor is displayed", MessageTypes.Pass);
			getNFKMoremenuHelppageInsulinmentorTxt().click();
		} else {
			Reporter.logWithScreenShot("Your Insulin Mentor is displayed", MessageTypes.Fail);
		}
	}

	public void clickNFKQuick_Tutorial() {
		if (getNFKMoremenuHelppageInsulinmentorOnetouchTxt().isPresent()) {
			Reporter.logWithScreenShot("OneTouch Reveal® Quick-Use Tutorial is displayed", MessageTypes.Pass);
			getNFKMoremenuHelppageInsulinmentorOnetouchTxt().click();

		} else {
			Reporter.logWithScreenShot("OneTouch Reveal® Quick-Use Tutorial is not displayed", MessageTypes.Fail);
		}
	...
	public void verifyInsulin_MentorScreen() {
		...
		if (getNFKMoremenuHelppageInsulinmentorUsingtheinsulinTxt().isPresent()) {
			Reporter.logWithScreenShot("Using the Insulin Mentor is displayed", MessageTypes.Pass);

		} else {
			Reporter.logWithScreenShot("Using the Insulin Mentor is not displayed", MessageTypes.Fail);
		}
		if (getNFKMoremenuHelppageInsulinmentorFaqTxt().isPresent()) {
			Reporter.logWithScreenShot("Frequently Asked Questions is displayed", MessageTypes.Pass);

		} else {
			Reporter.logWithScreenShot("Frequently Asked Questions is not displayed", MessageTypes.Fail);
		}
		if (getNFKMoremenuHelppageInsulinmentorTerminologyTxt().isPresent()) {
			Reporter.logWithScreenShot("Insulin Mentor Terminology is displayed", MessageTypes.Pass);

		} else {
			Reporter.logWithScreenShot("Insulin Mentor Terminology is not displayed", MessageTypes.Fail);
		}
		if (getNFKMoremenuHelppageInsulinmentorSettingTxt().isPresent()) {
			Reporter.logWithScreenShot("Insulin Mentor Settings is displayed", MessageTypes.Pass);

		} else {
			Reporter.logWithScreenShot("Insulin Mentor Settings is not displayed", MessageTypes.Fail);
		}
	...
	public void clickSafteyOnboarding() {
		try {
			...
			LFSUtilsAndroid.click(getNFKMoremenuHelppageSafteyonboardingBtn());
			getNFKMoremenuHelppageSkipBtn().isPresent();
			LFSUtilsAndroid.click(getNFKMoremenuHelppageSkipBtn());
			getNFKMoremenuHelppageTitleLbl().getText().equals(LFSUtilsAndroid.getPropString("safety.onboarding.title"));
			LFSUtilsAndroid.click(getNFKMoremenuHelppageSafteyonboardingBtn());
			Reporter.logWithScreenShot("Sucessfully clicked on saftey onboarding option", MessageTypes.Pass);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void clickAppTour() {
		try {
			...
			LFSUtilsAndroid.click(getNFKMoremenuHelppageApptourBtn());
			/*
			 * getNFKMoremenuHelppageSkipBtn().isPresent();
			 * getNFKMoremenuHelppageSkipBtn().click();
			 * getNFKMoremenuHelppageTitleLbl().getText().equals(LFSUtilsAndroid.
			 * getPropString("app.tour")); LFSUtilsAndroid.waitforLoad();
	...
	public void verifyAppTourScreen() {
		try {
			...
			LFSUtilsAndroid.click(getNFKMoremenuHelppageStatictextTxt(LFSUtilsAndroid.getPropString("appCommon.done")));
			getNFKmoremenuhelppagehelplbl().waitForPresent();
			Reporter.logWithScreenShot("Sucessfully verified App Tour Screen", MessageTypes.Pass);
		} catch (Exception e) {
			e.printStackTrace();
			Reporter.logWithScreenShot("Fail to verify App Tour Screen", MessageTypes.Fail);
		}
	}
	...
	public void clickUserGuide() {
		try {
			...
			LFSUtilsAndroid.click(getNFKMoremenuHelppageAppuserguideBtn());
			Reporter.logWithScreenShot("Sucessfully clicked on User Guide", MessageTypes.Pass);
		} catch (Exception e) {
			e.printStackTrace();
			Reporter.logWithScreenShot("Fail to click on user guide", MessageTypes.Fail);
		}
	}

	public void verifyUserGuideScreen() {
		try {
			getNFKMoremenuHelppageTitleLbltext().get(0).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.intro"));
			getNFKMoremenuHelppageTitleLbltext().get(1).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.getting.started"));
			getNFKMoremenuHelppageTitleLbltext().get(2).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.account"));
			getNFKMoremenuHelppageTitleLbltext().get(3).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.home"));
			getNFKMoremenuHelppageTitleLbltext().get(4).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.event.log"));
			getNFKMoremenuHelppageTitleLbltext().get(5).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.progress"));
			getNFKMoremenuHelppageTitleLbltext().get(6).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.alert"));
			getNFKMoremenuHelppageTitleLbltext().get(7).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.device"));
			getNFKMoremenuHelppageTitleLbltext().get(8).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.reminder"));
			LFSUtilsAndroid.swipePage();
			getNFKMoremenuHelppageTitleLbltext().get(9).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.share"));
			getNFKMoremenuHelppageTitleLbltext().get(10).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.connection"));
			getNFKMoremenuHelppageTitleLbltext().get(11).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.setting"));
			getNFKMoremenuHelppageTitleLbltext().get(12).getText()
					.equals(LFSUtilsAndroid.getPropString("app.userguide.term"));
			Reporter.logWithScreenShot("Sucessfully verified app user Guide", MessageTypes.Pass);
			Reporter.logWithScreenShot("Sucessfully verified app user Guide", MessageTypes.Pass);
		} catch (Exception e) {
			e.printStackTrace();
			Reporter.logWithScreenShot("Fail to verify app user Guide", MessageTypes.Fail);
		}
	...
	public void clickAbout() {
		try {
			LFSUtilsAndroid.click(getNFKmoremenuhelppageaboutbtn());
	...
	public void verifyAboutScreen() {
		try {
			...
			Reporter.logWithScreenShot("Sucessfully verified About Screen", MessageTypes.Pass);
		} catch (Exception e) {
			e.printStackTrace();
			Reporter.logWithScreenShot("Fail to verify About Screen", MessageTypes.Fail);
		}
	...
	public void clickOnSensorApp() {
		try {
			LFSUtilsAndroid.click(getNFKMoremenuHelppageSensorBtn());
			Reporter.logWithScreenShot("Sucessfully clicked on Sensor application option", MessageTypes.Pass);
		} catch (Exception e) {
			e.printStackTrace();
			Reporter.logWithScreenShot("Fail to click on sensor application option", MessageTypes.Fail);
		}
	}

	public void verifySensorAppScreen() {
		try {
			getNFKMoremenuHelppageSensorappOptions().get(0).getText()
					.equals(LFSUtilsAndroid.getPropString("help.sensor.apply.sensor"));
			getNFKMoremenuHelppageSensorappOptions().get(1).getText()
					.equals(LFSUtilsAndroid.getPropString("help.sensor.remove.sensor"));
			getNFKMoremenuHelppageSensorappOptions().get(2).getText()
					.equals(LFSUtilsAndroid.getPropString("help.sensor.help.tips"));
			Reporter.logWithScreenShot("Sucessfully verified Sensor application screen", MessageTypes.Pass);
		} catch (Exception e) {
			e.printStackTrace();
			Reporter.logWithScreenShot("Fail to verify sensor application screen", MessageTypes.Fail);
		}
	}
	...
	public void validateOptions() {
		try {
			for (int i = 0; i < 3; i++) {
				if (i == 0) {
					LFSUtilsAndroid.click(getNFKMoremenuHelppageSensorappOptions().get(i));
					getNFKMoremenuHelppageTitleLbl().getText()
							.equals(LFSUtilsAndroid.getPropString("help.sensor.apply.title"));
					LFSUtilsAndroid.click(getNFKMoremenuHelppageSensorappDoneBtn());
				} else if (i == 1) {
					LFSUtilsAndroid.click(getNFKMoremenuHelppageSensorappOptions().get(i));
					getNFKMoremenuHelppageTitleLbl().getText()
							.equals(LFSUtilsAndroid.getPropString("help.sensor.remove.title"));
					LFSUtilsAndroid.click(getNFKMoremenuHelppageSensorappDoneBtn());
				} else {
					LFSUtilsAndroid.click(getNFKMoremenuHelppageSensorappOptions().get(i));
					getNFKMoremenuHelppageTitleLbl().getText()
							.equals(LFSUtilsAndroid.getPropString("help.sensor.helptip.title"));
					LFSUtilsAndroid.click(getNFKMoremenuHelppageSensorappDoneBtn());
				}
			}
			Reporter.logWithScreenShot("Sucessfully validated sensor application screen option", MessageTypes.Pass);
		} catch (Exception e) {
			e.printStackTrace();
			Reporter.logWithScreenShot("Fail to validate sensor application screen option", MessageTypes.Fail);
		}
	}
	...
	public void clickLicense() {
		getNFKMoremenuHelppageStatictextTxt(LFSUtilsAndroid.getPropString("appCommon.licenses"))
				.assertPresent("UDI of Mobile");
		LFSUtilsAndroid.click(getNFKMoremenuHelppageStatictextTxt(LFSUtilsAndroid.getPropString("appCommon.licenses")));

	}

	public void verifyLicensePage() {
		try {
			Assert.assertEquals(getNFKMoremenuHelppageTitleLbl().getText(),
					LFSUtilsAndroid.getPropString("appCommon.licenses"));
			...
			e.printStackTrace();
			Reporter.logWithScreenShot("Failed to verify licence page", MessageTypes.Fail);
		}
	}

	public void clickBackButton() {
		try {
			LFSUtilsAndroid.click(getNFKMoremenuHelppageLicenseBackBtn());
		} catch (Exception e) {
