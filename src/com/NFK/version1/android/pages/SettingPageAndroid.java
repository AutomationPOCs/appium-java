...
public class SettingPageAndroid extends WebDriverBaseTestPage<WebDriverTestPage> {
	...
	public QAFWebElement getNFKiosSettingpageUsersettingsBtn(String Text) {
		return LFSUtilsAndroid.getElement("otr.moremenu.myreminderspage.staticText.btn", Text);
	}
	...
	@FindBy(locator = "NFK.settingsPage.userSetting.targetRange")
	private QAFWebElement NFKSettingsPageUserSettingTargetRange;
	@FindBy(locator = "NFK.settingsPage.rangePicker.lowerButton")
	private QAFWebElement NFKSettingsPageRangePickerLowerButton;
	@FindBy(locator = "NFK.settingsPage.rangePicker.upperButton")
	private QAFWebElement NFKSettingsPageRangePickerUpperButton;
	
	public QAFWebElement getNFKSettingsPageUserSettingTargetRange() {
		return NFKSettingsPageUserSettingTargetRange;
	}

	public QAFWebElement getNFKSettingsPageRangePickerLowerButton() {
		return NFKSettingsPageRangePickerLowerButton;
	}

	public QAFWebElement getNFKSettingsPageRangePickerUpperButton() {
		return NFKSettingsPageRangePickerUpperButton;
	}
	...
	// Method to verify setting page
	public void verifySettingsUI() {
		try {
			getNFKSettingspageTitl().verifyPresent("Settings Screen");
			Reporter.logWithScreenShot("User redirected to setting screen", MessageTypes.Pass);
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to redirect to setting screen", MessageTypes.Fail);
		}
	}

	public void clickOnUserSetting() {
		try {
		LFSUtilsAndroid.click(getNFKSettingspageUsersettingsBtn());
		Reporter.logWithScreenShot("User clicked on User setting");
		}catch (Exception e) {
			e.printStackTrace();
			Reporter.logWithScreenShot("Fail to click on user settings",MessageTypes.Fail);
		}
		}
	...
	public void verifySelectedCheckboxes() {
		...
		LFSUtilsAndroid.swipePage();
		LFSUtilsAndroid.verifyIfCheckboxChecked(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.dietExercise")));
		LFSUtilsAndroid.verifyIfCheckboxChecked(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.dietExercise")));
		LFSUtilsAndroid.verifyIfCheckboxChecked(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.oralMedication")));
		LFSUtilsAndroid.verifyIfCheckboxChecked(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.injectOther")));
		LFSUtilsAndroid.swipeWithScreenPercent(40, 70, 40, 30, 200);
		LFSUtilsAndroid.verifyIfCheckboxChecked(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.longActing")));
		LFSUtilsAndroid.verifyIfCheckboxChecked(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.mixedInsulin")));
		LFSUtilsAndroid.verifyIfCheckboxChecked(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.pump")));
		LFSUtilsAndroid.verifyIfCheckboxChecked(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.rapidActing")));
		Reporter.logWithScreenShot("All checkboxes are selected", MessageTypes.Pass);
	}
	...
	public void checkAllCheckboxes() {
		try {
			...
			LFSUtilsAndroid.swipePage();
			LFSUtilsAndroid.swipePage();
			LFSUtilsAndroid.click(getNFKSettingspageDiabetesQuestionchkbox(
					LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.dietExercise")));
			LFSUtilsAndroid.click(getNFKSettingspageDiabetesQuestionchkbox(
					LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.oralMedication")));
			LFSUtilsAndroid.click(getNFKSettingspageDiabetesQuestionchkbox(
			...
			if (getNFKSettingspageUsersettingsRapidactingNoBtn().isDisplayed()) {
				...
				LFSUtilsAndroid.click(getNFKSettingspageUsersettingsRapidactingNoBtn());
			}
			Reporter.logWithScreenShot("User selected all the checkboxes of Diabetes Management questions",
					MessageTypes.Pass);
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to select all the checkboxes of Diabetes Management questions",
					MessageTypes.Fail);
		}
	}
	...
	public void uncheckAllCheckboxes() {
		LFSUtilsAndroid.uncheckCheckBox(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.rapidActing")));
		LFSUtilsAndroid.uncheckCheckBox(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.pump")));
		LFSUtilsAndroid.uncheckCheckBox(getNFKSettingspageDiabetesQuestionchkbox(
		...
		LFSUtilsAndroid.uncheckCheckBox(getNFKSettingspageDiabetesQuestionchkbox(
				LFSUtilsAndroid.getPropString("more.aboutme.diabetesManagement.dietExercise")));
		Reporter.logWithScreenShot("All Checkboxes are unchecked", MessageTypes.Pass);
	...
	public void verifySelectedGenderAndDiabetesTypeOnSettingsPage() {
		try {
			...
			Reporter.logWithScreenShot("User verified gender and diabetes type on settings page", MessageTypes.Pass);
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to verify gender and diabetes type on settings page", MessageTypes.Fail);
		}
	}
	...
	public void verifyIcToggle() {
		...
		if (getTitle.isPresent()) {
			getNFKSettingspageStaticTextTxt(ConfigurationManager.getBundle().getString("appCommon.deactivate")).click();
		}
	}

	public void clickOnBack() {
		LFSUtilsAndroid.click(getNFKSettingspageBackBtn());
	...
	public void verifysensorValue(String settingdetail) {
		try {
			EventDetailBeans eventbean = new EventDetailBeans();

			if (settingdetail instanceof String) {
				eventbean.fillFromConfig(settingdetail);
			} else {
			...
			if (getNFKSettingspageBgdeafaultcompare().getText().replaceAll("\\s+", "")
					.equals(eventbean.getGlucosecompare().replaceAll("\\s+", ""))) {
				Reporter.logWithScreenShot("BG range compared successfully", MessageTypes.Pass);
			} else {
				Reporter.logWithScreenShot("BG Range was not matched", MessageTypes.Fail);
			}
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to verify glucose values", MessageTypes.Fail);
		}
	}

	public void changesensorValue(String bgvalue) {
		EventDetailBeans eventbean = new EventDetailBeans();

		if (bgvalue instanceof String) {
			eventbean.fillFromConfig(bgvalue);
		} else {
			eventbean.fillData(bgvalue);
		}
		Reporter.logWithScreenShot("Before changing bg target", MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKMoreMenuSettingspageSelectRange());
		String amountLow = LFSUtilsAndroid.mmolMGDL(Integer.parseInt(eventbean.getLowglucosevalue()));
		LFSUtilsAndroid.selectBGRangePicker(getNFKSettingspageBgRengePkr(), amountLow);
		LFSUtilsAndroid.click(getNFKSettingspageBgRengeokBtn());
		Reporter.logWithScreenShot("Low bg target changed", MessageTypes.Pass);
		LFSUtilsAndroid.click(getNFKMoreMenuSettingspageSelectRange());
		LFSUtilsAndroid.click(getNFKSettingspageBgrangeforwardarrow());
	...
	public void verifyEditedTargetRanges(String updatedrange) {
		try {
			EventDetailBeans eventbean = new EventDetailBeans();
			if (updatedrange instanceof String) {
				eventbean.fillFromConfig(updatedrange);
			} else {
			...
			if (getNFKSettingspageBgdeafaultcompare().getAttribute("text").contains("mg/dL")) {
				editedValue = getNFKSettingspageBgdeafaultcompare().getAttribute("text").replaceAll("\\s+", "")
						.replace(delmg, "").toString();
			} else {
				editedValue = getNFKSettingspageBgdeafaultcompare().getAttribute("text").replaceAll("\\s+", "")
						.replace(delmm, "").toString();
			}
			...
			Reporter.logWithScreenShot("Fail to verify edited target range", MessageTypes.Fail);
		}
	...
	public void clickOnCancel() {
		LFSUtilsAndroid.click(getNFKSettingspageBgdeafaultcompare());
		LFSUtilsAndroid.click(getNFKSettingspageCancelBtn());
		Reporter.logWithScreenShot("User clicked on Cancel button ", MessageTypes.Pass);
	}
	...
	public void verifyEventsofSystemsetting(String option) {
		try {
			getNFKSettingspageEventTitle().verifyPresent("Event title");
			...
			switch (option) {
			case "ENABLED":
				if (getNFKSettingspageLoginsulinToggleBtn().isPresent()
						&& getNFKSettingspageOverlaytimelineToggleBtn().isPresent()) {
					getNFKSettingspageLoginsulinToggleBtn().verifyEnabled("Log Insulin button");
					getNFKSettingspageOverlaytimelineToggleBtn().verifyEnabled("Overlay Events on Timeline");
					Reporter.logWithScreenShot("Log Insulin and Overlay buttons are Enabled", MessageTypes.Pass);
				}
				break;
			case "DISABLED":
				if (getNFKSettingspageLoginsulinToggleBtn().isDisplayed()
						&& getNFKSettingspageOverlaytimelineToggleBtn().isDisplayed()) {
					getNFKSettingspageLoginsulinToggleBtn().verifyDisabled("Log insulin button");
					getNFKSettingspageOverlaytimelineToggleBtn().verifyDisabled("Overlay Events on Timeline");
					Reporter.logWithScreenShot("Log Insulin and Overlay buttons are disabled", MessageTypes.Pass);
				}
				break;
			}
			Reporter.logWithScreenShot("User verified Log Insulin and Overlay Event", MessageTypes.Pass);

		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to verify Log Insulin and Overlay Event", MessageTypes.Fail);
		}
	}
	...
	public void clickTheEvents(String option) {
		try {
			...
			switch (option) {
			case "ENABLED":
				if (!(getNFKSettingspageLoginsulinToggleBtn().isEnabled()
						& getNFKSettingspageOverlaytimelineToggleBtn().isEnabled())) {
					LFSUtilsAndroid.click(getNFKSettingspageLoginsulinToggleBtn());
					LFSUtilsAndroid.click(getNFKSettingspageOverlaytimelineToggleBtn());
				}
				break;
			case "DISABLED":
				if (getNFKSettingspageLoginsulinToggleBtn().isEnabled()
			...
			Reporter.logWithScreenShot("Events buttons are disabled", MessageTypes.Pass);
		} catch (Exception e) {
			Reporter.logWithScreenShot("Fail to disable Events buttons", MessageTypes.Fail);
		}
	}
	...
	public void verifiesSystemSettings() {
		...
		Assert.assertEquals(getNFKSettingspageSystemAccountLbl().get(0).getText(),
				LFSUtilsAndroid.getPropString("settings.system.current.reading.lbl"));
		Assert.assertEquals(getNFKSettingspageSystemAccountLbl().get(1).getText(),
				LFSUtilsAndroid.getPropString("settings.system.timeline.lbl"));
		Assert.assertEquals(getNFKSettingspageSystemAccountLbl().get(2).getText(),
				LFSUtilsAndroid.getPropString("settings.system.events.lbl"));
		Assert.assertEquals(getNFKSettingspageSystemTextLbl().get(0).getText(),
				LFSUtilsAndroid.getPropString("settings.system.animation.lbl"));
		Assert.assertEquals(getNFKSettingspageSystemTextLbl().get(1).getText(),
				LFSUtilsAndroid.getPropString("settings.system.log.insulin.lbl"));
	...
	// Rushikesh
		...
		public void VerifyByDefaultTargetRange(String targetRange) {
			try {
				...
				softAssert.assertEquals(getNFKSettingsPageUserSettingTargetRange().getText(),
						LFSUtilsAndroid.getPropString("userSetting.targetRange"));
		...
		// Rushikesh
		// Method to set target range
		public void setTargetRange(String low, String High) {
			try {
				LFSUtilsAndroid.selectBGRangePicker(getNFKSettingspageBgRengePkr(), low);
				LFSUtilsAndroid.click(getNFKSettingspageBgrangeforwardarrow());
				LFSUtilsAndroid.selectBGRangePicker(getNFKSettingspageBgRengePkr(), High);
				getNFKSettingspageBgRengeokBtn().click();
				Reporter.logWithScreenShot("Succesfully set target Range", MessageTypes.Pass);
			} catch (Exception e) {
				Reporter.logWithScreenShot("Failed to set target Range", MessageTypes.Fail);
			}
		}
		// Rushikesh
		...
		public void changeTargetRange(String targetRange) {
			...
			switch (targetRange) {
			case "100-180 mg/dL":
				LFSUtilsAndroid.click(getNFKSettingsPageUserSettingTargetRange());
				setTargetRange("100", "180");
				break;
			case "60–90 mg/dL":
				LFSUtilsAndroid.click(getNFKSettingsPageUserSettingTargetRange());
				setTargetRange("60", "90");
				break;
			case "65–190 mg/dL":
				LFSUtilsAndroid.click(getNFKSettingsPageUserSettingTargetRange());
				setTargetRange("65", "190");
				break;
			case "70–180 mg/dL":
				LFSUtilsAndroid.click(getNFKSettingsPageUserSettingTargetRange());
				setTargetRange("70", "180");
				break;
			case "100–190 mg/dL":
				LFSUtilsAndroid.click(getNFKSettingsPageUserSettingTargetRange());
				setTargetRange("100", "190");
				break;
			}
		} 
}
