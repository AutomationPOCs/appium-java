...
public class UserDetailBeans extends BaseDataBean {
	...
	String zipCode;
	String phoneNumber;
	String birthdayMonth1;
	String birthdayDate1;
	String birthdayYear1;
	...
	String FollowerName;
	String FollowerEmail;
	String Expiredusername;
	String FollowerName1;
	...
	public String getFollowerName1() {
		return FollowerName1;
	}

	public void setFollowerName1(String FollowerName1) {
		this.FollowerName1 = FollowerName1;
	}
	...
	public String getGlucosecompare() {
		return glucosecompare;
	}

	public void setGlucosecompare(String glucose) {
		glucosecompare = glucose;
	}

	public String getBirthdayMonth1() {
		return birthdayMonth1;
	}

	public void setBirthdayMonth1(String birthdayMonth1) {
		this.birthdayMonth1 = birthdayMonth1;
	}

	public String getBirthdayDate1() {
		return birthdayDate1;
	}

	public void setBirthdayDate1(String birthdayDate1) {
		this.birthdayDate1 = birthdayDate1;
	}

	public String getBirthdayYear1() {
		return birthdayYear1;
	}

	public void setBirthdayYear1(String birthdayYear1) {
		this.birthdayYear1 = birthdayYear1;
	}
